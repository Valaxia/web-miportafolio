...
function dl_enqueue_style() {
	...
	wp_register_style( 'fonts', 'https://fonts.googleapis.com/css?family=Montserrat:200,300,400,500,600,800', null, null, 'screen' );
	...
	wp_register_style( 'main_style', get_theme_file_uri( '/assets/css/miestilo.css'), array('bootstrap', 'fonts'), $theme_data->get( 'Version' ), 'screen' );
