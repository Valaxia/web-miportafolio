...
function dl_enqueue_scripts() {
	...
	/* Register Scripts */
	wp_register_script( 'masonry', get_theme_file_uri('/assets/js/lib/masonry.pkgd.js'), $deps, null, true );
	wp_register_script( 'bootstrap', get_theme_file_uri('/assets/js/lib/bootstrap.js'), $deps, null, true );
	wp_register_script( 'easing', get_theme_file_uri('/assets/js/lib/jquery.easing.1.3.js'), $deps, null, true );
	wp_register_script( 'quicksand', get_theme_file_uri('/assets/js/lib/jquery.quicksand.js'), array('jquery-migrate', 'easing'), null, true );
	...
	wp_register_script( 'main_js', get_theme_file_uri('/assets/js/functions.js'), array('quicksand', 'masonry', 'bootstrap'), $theme_data->get( 'Version' ), true );
